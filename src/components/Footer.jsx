...
export default function Footer() {
  return (
    <footer className="px-6 py-12 flex flex-col gap-8 items-center text-center bg-gray-950 capitalize font-medium lg:flex-row lg:text-left lg:items-stretch">
      <h2 className="text-white text-4xl font-bold lg:flex-1 text-center my-4">
        shortly
      </h2>
