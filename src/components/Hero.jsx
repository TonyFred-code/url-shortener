  ...
  return (
    <section className="flex flex-col p-3 md:flex-row overflow-hidden md:px-12 lg:px-32 max-h-200 gap-8 md:py-8">
      <div className="flex flex-col items-center text-center md:flex-1 md:text-left md:items-start md:justify-center">
        <h1 className="text-5xl font-extrabold lg:text-7xl text-gray-900 mb-4">
        ...
        <button
          type="button"
          className="my-4 rounded-full bg-blue-400 text-white py-3 px-12 font-bold capitalize md:my-8 cursor-pointer hover:bg-blue-450"
        >
          get started
        </button>
      </div>
